 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Happy_Sniffs_NamingConventions_ValidVariableNameSniff extends PHP_CodeSniffer_Standards_AbstractVariableSniff
{
        ...
        if ($tokens[$objOperator]['code'] === T_OBJECT_OPERATOR) {
            ...
            if ($tokens[$var]['code'] === T_STRING) {
                ...
                if ($tokens[$bracket]['code'] !== T_OPEN_PARENTHESIS) {
                    ...
                    if (PHP_CodeSniffer::isCamelCaps($objVarName, false, true, false) === false && !isset($tokens[$var]['level'])) {
